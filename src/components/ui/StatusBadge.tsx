...
/** Req 58 — prefer next-approver phrasing. */
const STATUS_LABELS: Record<string, string> = {
  PENDING_STORE: 'Approved by Store',
  ALLOCATED: 'Approved by Store',
  FORWARDED_TO_PM: 'Approved by PM',
  BRANCH_TRANSFER_REQUESTED: 'Approved by PM',
  PENDING_HO: 'Approved by Executive',
  PENDING_EXECUTIVE_DECISION: 'Approved by Executive',
  EXECUTIVE_DECISION_PO: 'Approved by Coordinator',
  EXECUTIVE_DECISION_BRANCH_TRANSFER: 'Approved by Coordinator',
  PM_APPROVED: 'Approved by Store Incharge',
  ...
  COORDINATOR_VERIFIED: 'Approved by Chairman',
  CHAIRMAN_APPROVED: 'Approved by Store',
  REJECTED: 'Rejected',
  CANCELLED: 'Cancelled',
  CHAIRMAN_PENDING: 'Approved by Chairman',
  COORDINATOR_PENDING: 'Approved by Coordinator',
  PENDING_REVIEW: 'Approved by Coordinator',
  PENDING_APPROVAL: 'Approved by Chairman',
  ...
  IN_REVIEW: 'In review',
  RESOLVED: 'Resolved',
  PENDING_DESTINATION_PM: 'Approved by PM',
  PENDING_SOURCE_FINAL: 'Approved by PM',
  ...
  EXECUTIVE_PENDING: 'Approved by Executive',
  PM_PENDING: 'Approved by Coordinator',
};
