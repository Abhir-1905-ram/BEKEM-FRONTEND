  ...
  switch (role) {
    ...
    case UserRole.EXECUTIVE:
      return [
        ...
        { id: 'ho-indents', label: 'Generate indent (HO)', href: '/executive/ho-indents', icon: FilePlus, section: 'workspace' },
    ...
    case UserRole.COORDINATOR:
      return [
        ...
        { id: 'ho-indents', label: 'HO indent approvals', href: '/coordinator/ho-indents', icon: FilePlus, section: 'workspace' },
